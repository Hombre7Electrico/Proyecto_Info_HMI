...
//  CONFIGURACIONES INICIALES DE LA APLICACIÓN SERVIDOR DDE
void __fastcall TForm1::FormCreate(TObject *Sender)
{
 //CONFIGURACION INICIAL DE LA CONVERSACION LADO CLIENTE
DdeClientConv1->ConnectMode = ddeManual; //modo de conexión MANUAL
DdeClientConv1->DdeService = "SERVIDOR_Project1";  //nombre “exe” del servidor
DdeClientConv1->DdeTopic = "DdeServerConv1"; //nombre Convesación servidor
...
DdeClientItem1->DdeConv = DdeClientConv1; //conversación que se usará
DdeClientItem2->DdeConv = DdeClientConv1; //conversación que se usará
DdeClientItem3->DdeConv = DdeClientConv1; //conversación que se usará
DdeClientItem4->DdeConv = DdeClientConv1; //conversación que se usará
DdeClientItem5->DdeConv = DdeClientConv1; //conversación que se usará
 //CONFIGURACION DE LOS ITEMS QUE LEERAN EN EL SERVIDOR
DdeClientItem1->DdeItem = "DdeServerItem1"; //Item server al que se conectará
DdeClientItem2->DdeItem = "DdeServerItem2"; //Item server al que se conectará
DdeClientItem3->DdeItem = "DdeServerItem3"; //Item server al que se conectará
DdeClientItem4->DdeItem = "DdeServerItem4"; //Item server al que se conectará
DdeClientItem5->DdeItem = "DdeServerItem5"; //Item server al que se conectará
